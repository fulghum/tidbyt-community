                ...
                children = [
                    render.Row(
                        ...
                        children = [
                            render.Padding(
                                pad = (1, 1, 1, 1),
                                child = render.Image(GITHUB_ICON, height = image_size),
                            ),
